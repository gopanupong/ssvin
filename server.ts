...
สำหรับการประเมินระดับดัชนีความสมบูรณ์และหมวดหมู่ ให้ใช้เกณฑ์ดังนี้:
- หมวดหมู่ (category): กำหนดเป็นหนึ่งในหัวข้อตามที่วิเคราะห์ได้จริงจากภาพ ได้แก่ 'Battery', 'Yard', 'Checklist', 'Roof', 'Fence', 'Security', หรือ 'Other'

โดยเฉพาะหัวข้อ **'Battery' (แบตเตอรี่)** ให้ประเมินระดับน้ำกลั่นและสภาพขั้วแบตเตอรี่อย่างเข้มงวดและให้คะแนน (score) ตามเกณฑ์ดังนี้:
* 100 คะแนน: ระดับน้ำกลั่นทุกลูกอยู่ระหว่างขีด Upper-Lower เห็นได้เด่นชัดเจนในรูปภาพ และขั้วแบตเตอรี่สะอาดไม่มีคราบเกลือ/คราบเกลือซัลเฟต
* 50 คะแนน: มีแบตเตอรี่บางลูกที่ระดับน้ำกลั่นเริ่มลดลงมาต่ำกว่ากึ่งกลางแต่ยังไม่พ้นขีดล่าง (Lower) หรือภาพถ่ายเบลอมืด/ไกลจนประเมินระดับน้ำกลั่นได้ยาก ลายตา หรือระบุได้ไม่ชัดเจน
* 0 คะแนน: น้ำกลั่นแห้งหรืออยู่ต่ำกว่าขีดล่าง (Lower) หรือพบความชำรุดเสียหาย บวม แตกร้าว รั่วซึม หรือมีความผิดปกติอย่างชัดเจนที่ตัวถังแบตเตอรี่ หรือขั้วแบตมีคราบเกลือซัลเฟตขึ้นหนามาก

สำหรับหัวข้ออื่นๆ (เช่น Yard, Checklist, Roof, Fence, Security, Other) ให้ประเมินคะแนนสภาพจาก 0 ถึง 100 คะแนนตามความเรียบร้อย (หากสมบูรณ์สะอาดเป็น 100, หักคะแนน 10-50 คะแนนตามระดับความเสียหาย/ความรกขยะฝุ่นละออง/รอยแตกร้าว)

ในช่อง 'summary' ให้ระบุรายงานผลการวิเคราะห์ระดับน้ำกลั่น สภาพแบตเตอรี่ หรือหัวข้ออื่นๆ ที่สแกนเจอเป็นภาษาไทยอย่างละเอียดเข้าใจง่าย

ตอบกลับในรูปแบบ JSON เท่านั้น โดยมีโครงสร้างดังนี้:
{
  "status": "Red" หรือ "Green" (Red หากประเมินคะแนนได้ 50 หรือ 0 หรือพบข้อบกพร่องสำคัญ, Green หากประเมินคะแนนได้ 100 และสภาพปลอดภัยเรียบร้อยดี),
  "findings": ["Weed", "Bird Droppings", "Low Water Level", "Dirty Terminals", ...], (อาเรย์ระบุคำหลักปัญหาที่พบ),
  "summary": "สรุปผลการวิเคราะห์สั้นๆ เป็นภาษาไทย พร้อมบอกระดับน้ำกลั่นและเงื่อนไขแบตเตอรี่หากเป็นภาพแบตเตอรี่",
...
* 100 คะแนน: ระดับน้ำกลั่นทุกลูกอยู่ระหว่างขีด Upper-Lower เห็นได้เด่นชัดเจนในรูปภาพ และขั้วแบตเตอรี่สะอาดไม่มีคราบเกลือ/คราบเกลือซัลเฟต
* 50 คะแนน: มีแบตเตอรี่บางลูกที่ระดับน้ำกลั่นเริ่มลดลงมาต่ำกว่ากึ่งกลางแต่ยังไม่พ้นขีดล่าง (Lower) หรือภาพถ่ายเบลอมืด/ไกลจนประเมินระดับน้ำกลั่นได้ยาก ลายตา หรือระบุได้ไม่ชัดเจน
* 0 คะแนน: น้ำกลั่นแห้งหรืออยู่ต่ำกว่าขีดล่าง (Lower) หรือพบความชำมุดเสียหาย บวม แตกร้าว รั่วซึม หรือมีความผิดปกติอย่างชัดเจนที่ตัวถังแบตเตอรี่ หรือขั้วแบตมีคราบเกลือซัลเฟตขึ้นหนามาก

...
• **หัวข้อ Battery (แบตเตอรี่ - น้ำกลั่นและสภาพขั้วแบต):**
  - **ข้อกำหนดการคัดกรองความคมชัด (รูปไม่ชัดไม่ต้องวิเคราะห์ภาพ):** หากรูปภาพที่ส่งเข้ามานี้มีความเบลอ มืด ถ่ายมุมกว้างหรือระยะไกลเกินไป จนไม่สามารถสังเกตเห็นระดับของเหลวหรือตัวอักษรบนตัวถังได้อย่างคมชัดแม่นยำ (จัดว่าปนรูปไม่ชัดเจน) **ให้งดเว้นการวิเคราะห์ระดับน้ำกลั่นของภาพนี้ทันที** โดยตอบกลับด้วยประเภทดัชนีเป็น: status: "Green", score: 100, findings: [], และ summary: "รูปภาพแบตเตอรี่ไม่ชัดเจนหรือเบลอ ข้ามการวิเคราะห์ระดับน้ำกลั่นตามเกณฑ์ผู้ใช้งาน" เพื่อไม่ให้รูปภาพที่ไม่คมชัดมาเบียดบังหรือดึงระดับดัชนีสุขภาพรวมให้ต่ำลง
  - **ข้อกำหนดสำหรับรูปภาพที่ชัดเจนมากพอ (วิเคราะห์ลูกแบตเตอรี่ที่ชัดสุดเพียง 1 ลูกเท่านั้น):** หากรูปภาพนี้มีความคมชัดเห็นพิกัดรายละเอียดชัดเจน ให้คัดตัวเลือก **ลูกแบตเตอรี่เพียงลูกเดียวที่เห็นสติกเกอร์แสดงหมายเลขและระดับน้ำเด่นชัดที่สุดในภาพเพื่อนำมาประเมิน (ห้ามวิเคราะห์ภาพรวมทุกลูก หรือห้ามหักคะแนนจากลูกอื่นที่ไม่ได้เลือก)** พร้อมระบุหมายเลขลูกแบตเตอรี่ลูกที่นำมาประเมินนั้นให้ละเอียดและระชัดเจน (เช่น แบตเตอรี่หมายเลข 5 หรือหมายเลขอื่นๆ ตามสติกเกอร์ที่เห็นชัดที่สุด)
  - วิเคราะห์และเปรียบเทียบระดับสีของเหลวหรือน้ำกลั่นเฉพาะลูกที่เลือกนี้กับเส้นพิกัดสูงสุด (MAX / Upper limit) และต่ำสุด (MIN / Lower limit) บนตัวถังของลูกนั้นๆ
  - **100 คะแนน:** ระดับน้ำกลั่นของลูกแบตเตอรี่ที่ได้รับเลือก (ลูกเดี่ยวที่เห็นชัดเจนที่สุดเพียง 1 ลูก) สถิติตัวอยู่กึ่งกลางปกติระหว่างช่วงพิกัด Upper และ Lower ชัดเจน ขั้วแบตเตอรี่สะอาดปราศจากคราบฟุ้งซัลเฟตหรือคราบเกลือขาวฟ้า
  - **50 คะแนน:** ลูกแบตเตอรี่ที่ได้รับเลือก (ลูกเดี่ยวที่เห็นชัดเจนที่สุดเพียง 1 ลูก) มีระดับน้ำค่อนข้างต่ำผิดสังเกต (ตกอยู่ใต้แนวแนวกลางไปหาขีด LOWER) แต่ยังไม่หลุดขีดล่างลงมา หรือมีฝุ่นละอองจับขั้วบางเบา
  - **0 คะแนน:** ลูกแบตเตอรี่ที่ได้รับเลือก (ลูกเดี่ยวที่เห็นชัดเจนที่สุดเพียง 1 ลูก) ปรากฏพิกัดน้ำแห้งสนิทหรือตกทะลุใต้ระดับขีดจำกัดล่าง (MIN/Lower Limit) หรือพบลักษณะความผิดปรกติของลูกชัดสุดนี้อย่างรุนแรง เช่น ตัวถังบวม แตก ร้าว รั่วซึม หรือมีเกลือซัลเฟตสีขาว/ฟ้าเกาะพอกหนาที่ขั้วอย่างร้ายแรง
...
- หากวิเคราะห์ได้ว่าเป็น 'Battery' และรูปมีความชัดเจนเพียงพอในการประเมิน: ให้เขียนรายงานสรุปพิกัดสถานะน้ำกลั่นและขั้วของลูกแบตเตอรี่หมายเลขเดียวที่โดดเด่นและเห็นชัดที่สุดในภาพเดี่ยวเพียง 1 ลูกเท่านั้น เช่น "จากการตรวจสอบระบบแบตเตอรี่ OPzS โดยคัดกรองพิกัดลูกแบตเตอรี่ชัดสุดเพียง 1 ลูก คือ แบตเตอรี่หมายเลข 5 พบว่าระดับน้ำกลั่นคงแนวพิกัดปกติเหนือสีขอบ MIN และอยู่ในระดับปลอดภัยระหว่างขีด Upper-Lower สภาพขั้วสะอาดเรียบร้อยปราศจากคราบเกลือ" (รายงานเจาะจงเฉพาะลูกชัดที่สุด 1 ลูกเท่านั้น ไม่วิเคราะห์รวม)
- หากเป็นกรณีรูปภาพ 'Battery' ที่เบลอและกระดำกระด่าง: ให้รายงานระบุว่า "รูปภาพแบตเตอรี่ไม่ชัดเจนหรือเบลอ ข้ามการวิเคราะห์ระดับน้ำกลั่นตามเกณฑ์ผู้ใช้งาน"
...
ตอบกลับในรูปแบบ JSON เท่านั้น โดยมีโครงสร้างดังนี้:
{
  ...
  "summary": "สรุปรายงานการวิเคราะห์รายภาพตามเงื่อนไข (สำหรับ Battery จะเจาะจงลูกที่ชัดที่สุดลูกเดียวในภาพ และถ้าภาพไม่ชัดจะสรุปข้ามการประเมิน)",
...
In the 'summary' field, provide a detailed analysis in Thai about what was surveyed and evaluated referring to the audit criteria. (สำคัญมาก: หากหมวดหมู่คือ Battery และภาพมีความชัดเจนเพียงพอ ให้รายงานสรุปถึงพิกัดระดับน้ำกลั่นและสถานะขั้วต่อเฉพาะลูกที่ชัดเจนที่สุดเพียง 1 ลูกเท่านั้น ไม่ต้องวิเคราะห์ทุกลูกหรือสรุปแบบภาพรวม และหากภาพไม่ชัดให้แจ้งว่าข้ามการวิเคราะห์ตามเกณฑ์ผู้ใช้งาน)

ตอบกลับในรูปแบบ JSON เท่านั้น โดยมีโครงสร้างดังนี้:
{
  "status": "Green" (เมื่อไม่มีข้อชำรุดบกพร่องตามเกณฑ์คะแนนต่ำ เช่น ประเมินได้คะแนนเต็ม) หรือ "Red" (เมื่อได้คะแนนต่ำ หรือมีสิ่งบกพร่องสำคัญอย่างเห็นได้ชัด),
  "findings": ["Weed", "Bird Droppings", "Low Water Level", "Dirty Terminals", ...], (ระบุคำหลักข้อขัดข้องที่ตรวจพบ),
  "summary": "สรุปรายงานผลการวิเคราะห์ระดับน้ำกลั่นและขั้วเฉพาะลูกแบตเตอรี่ที่เห็นชัดเจนที่สุดเพียงลูกเดียว 1 ลูกเท่านั้นระบุหมายเลขลูกให้ชัดเจนที่สุด (หากภาพไม่ชัดให้สรุปความว่าข้ามการประเมินภาพไม่ชัด)",
  "category": "Battery" | "Yard" | "Checklist" | "Roof" | "Fence" | "Security" | "Other",
  "score": 100
}`;
